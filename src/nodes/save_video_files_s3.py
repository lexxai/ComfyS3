...
class SaveVideoFilesS3:
    ...
    def save_video_files(self, filenames, filename_prefix: str = "VideoFiles", move_file: bool = True):
        ...
        for path in local_files:
            ...
            file_path = S3_INSTANCE.upload_file(path, s3_path, move_file=move_file)
